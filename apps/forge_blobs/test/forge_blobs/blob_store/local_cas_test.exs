defmodule ForgeBlobs.LocalCASTest do
  ...
  alias ForgeBlobs.{Config, FileSystem, LocalCAS, Source, StagedRef}
  ...
  describe "staged survivor recovery boundary" do
    ...
    test "effective configured cap applies to survivors", context do
      previous = Application.fetch_env!(:fornacast, :blob_max_bytes)
      Application.put_env(:fornacast, :blob_max_bytes, 4)

      on_exit(fn ->
        Application.put_env(:fornacast, :blob_max_bytes, previous)
      end)
