defmodule FornacastAPI.Serializers.V2022_11_28.Pull do
  alias FornacastAPI.{Serializer, URL}
  alias FornacastAPI.Serializers.V2022_11_28
  ...
  def render(pull, opts) do
    ...
    repository = V2022_11_28.render(:repository, view, actor: Keyword.get(opts, :actor))
    owner_user = V2022_11_28.render(:simple_user, view.owner, [])
  ...
  defp head_branch(pull, opts) do
    ...
    case Keyword.get(opts, :head_repository_view, default_view) do
      ...
      view ->
        repository = V2022_11_28.render(:repository, view, actor: Keyword.get(opts, :actor))
        user = V2022_11_28.render(:simple_user, view.owner, [])
