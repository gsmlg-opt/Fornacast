defmodule FornacastAPI.Serializers.V2026_03_10.Issue do
  ...
  defp pull_request(issue, owner, repo, opts) do
    ...
    |> maybe_put_merged_at(timestamp(Map.get(pull, :merged_at) || Map.get(pull, "merged_at")))
  end
  ...
  defp maybe_put_merged_at(map, nil), do: map
  defp maybe_put_merged_at(map, value), do: Map.put(map, :merged_at, value)
