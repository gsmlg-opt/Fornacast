defmodule FornacastAPI.Serializers.V2022_11_28 do
  alias FornacastAPI.Serializer.Fields
  alias FornacastAPI.Serializers.V2022_11_28.{Issue, IssueComment, Pull, Release}
  ...
  @minimal_repository_keys ~w(
    ...
    full_name git_commits_url git_refs_url git_tags_url git_url has_discussions has_downloads
    has_issues has_pages has_projects has_wiki homepage hooks_url html_url id issue_comment_url
    issue_events_url issues_url keys_url labels_url language languages_url license merges_url
    milestones_url mirror_url name network_count node_id notifications_url open_issues
    open_issues_count owner permissions private pulls_url pushed_at releases_url size ssh_url
    stargazers_count stargazers_url statuses_url subscribers_count subscribers_url subscription_url
    svn_url tags_url teams_url topics trees_url updated_at url visibility watchers watchers_count
  )a
  ...
  def render(:rate_limit, bucket, _opts) do
    core = Fields.rate_limit(bucket)
    %{resources: %{core: core}, rate: core}
  end
