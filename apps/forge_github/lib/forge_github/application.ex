  ...
  def start(_type, _args) do
    ...
    children =
      [
        ...
        {Task.Supervisor, name: ForgeGitHub.RepositoryCreationTaskSupervisor, max_children: 2},
        ...
        {ForgeGitHub.RepositoryCreationWorker, [enabled: app_configuration != :disabled]},
